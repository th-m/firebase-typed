 ...
 */ var Uo = /** @class */ function() {
    ...
    return t(n, e), n.prototype.ku = function() {
        if (this.$u) throw new I(b.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
...
/** Stops listening to the query. */ function Ss(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = k(t), i = e.xh.get(r), (o = e.$h.get(i.targetId)).length > 1 ? [ 2 /*return*/ , (e.$h.set(i.targetId, o.filter((function(t) {
                    return !er(t, r);
...
function qs(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(c) {
            switch (c.label) {
              case 0:
                return o = k(t), s = [], u = [], a = [], o.xh.m() ? [ 3 /*break*/ , 3 ] : (o.xh.forEach((function(t, e) {
...
var nu = /** @class */ function() {
     ...
     * HTTP).
     */
    return t(n, e), n.prototype.xl = function(t, e, n, r) {
 ...
 */ var lu = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.", pu = /** @class */ function() {
    ...
    return t(n, e), n.prototype.r_ = function(t) {
...
var _u = /** @class */ function(e) {
    ...
    return t(n, e), n.delete = function() {
        return F("FieldValue.delete", arguments), new Du(new Iu("FieldValue.delete"));
    }, n.serverTimestamp = function() {
        return F("FieldValue.serverTimestamp", arguments), new Du(new _u("FieldValue.serverTimestamp"));
    }, n.arrayUnion = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return G("FieldValue.arrayUnion", arguments, 1), new Du(new Tu("FieldValue.arrayUnion", t));
    }, n.arrayRemove = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return G("FieldValue.arrayRemove", arguments, 1), new Du(new Nu("FieldValue.arrayRemove", t));
    }, n.increment = function(t) {
        return j("FieldValue.increment", "number", 1, t), q("FieldValue.increment", arguments, 1), 
 ...
 */ function Gu(t, e) {
    ...
    return function(t, e) {
        ...
        throw e.a_("Unsupported field value: " + X(t));
    }(t, e);
}
 ...
 */
    ...
    return t.prototype.get = function(t) {
        ...
        var n = Ia("Transaction.get", t, this.pf);
        return this.bf.D_([ n.w_ ]).then((function(t) {
            if (!t || 1 !== t.length) return D();
            var r = t[0];
            if (r instanceof qn) return new ua(e.pf, n.w_, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.m_);
            if (r instanceof Fn) return new ua(e.pf, n.w_, r, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.m_);
            throw D();
        }));
        ...
        var r = Ia("Transaction.set", t, this.pf);
        n = ga("Transaction.set", n);
        var i = _a(r.m_, e, n), o = Cu(this.pf.Ef, "Transaction.set", r.w_, i, null !== r.m_, n);
        ...
        r = Ia("Transaction.update", t, this.pf), i = Fu(this.pf.Ef, "Transaction.update", r.w_, e, n, o)) : (q("Transaction.update", arguments, 2), 
        r = Ia("Transaction.update", t, this.pf), i = Mu(this.pf.Ef, "Transaction.update", r.w_, e)), 
        this.bf.update(r.w_, i), this;
    }, t.prototype.delete = function(t) {
        q("Transaction.delete", arguments, 1);
        var e = Ia("Transaction.delete", t, this.pf);
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        var r = Ia("WriteBatch.set", t, this.pf);
        n = ga("WriteBatch.set", n);
        var i = _a(r.m_, e, n), o = Cu(this.pf.Ef, "WriteBatch.set", r.w_, i, null !== r.m_, n);
        ...
        r = Ia("WriteBatch.update", t, this.pf), i = Fu(this.pf.Ef, "WriteBatch.update", r.w_, e, n, o)) : (q("WriteBatch.update", arguments, 2), 
        r = Ia("WriteBatch.update", t, this.pf), i = Mu(this.pf.Ef, "WriteBatch.update", r.w_, e)), 
        this.vf = this.vf.concat(i.T_(r.w_, wn.exists(!0))), this;
    }, t.prototype.delete = function(t) {
        q("WriteBatch.delete", arguments, 1), this.Df();
        var e = Ia("WriteBatch.delete", t, this.pf);
    ...
    return t(n, e), n.gf = function(t, e, r) {
        ...
        var n = _a(this.m_, t, e), r = Cu(this.firestore.Ef, "DocumentReference.set", this.w_, n, null !== this.m_, e);
        ...
        n = Fu(this.firestore.Ef, "DocumentReference.update", this.w_, t, e, r)) : (q("DocumentReference.update", arguments, 1), 
        ...
        "object" != typeof i[u] || Ju(i[u]) || (Z("DocumentReference.onSnapshot", s = i[u], [ "includeMetadataChanges" ]), 
        ...
        var e = this;
        B("DocumentReference.get", arguments, 0, 1), ba("DocumentReference.get", t);
        var n = this.firestore._f();
        return t && "cache" === t.source ? n.j_(this.w_).then((function(t) {
            return new ua(e.firestore, e.w_, t, 
    ...
    n.prototype.Cf = function(t) {
        ...
        return new ua(this.firestore, this.w_, e, t.fromCache, t.hasPendingWrites, this.m_);
    }, n;
    ...
    return t.prototype.data = function(t) {
        ...
        get: function() {
            return new oa(this.w_, this.pf, this.m_);
        },
        enumerable: !1,
        configurable: !0
...
var va = /** @class */ function() {
    ...
    return t.prototype.where = function(e, n, r) {
        ...
        var i = Y("Query.where", [ "<" /* LESS_THAN */ , "<=" /* LESS_THAN_OR_EQUAL */ , "==" /* EQUAL */ , "!=" /* NOT_EQUAL */ , ">=" /* GREATER_THAN_OR_EQUAL */ , ">" /* GREATER_THAN */ , "array-contains" /* ARRAY_CONTAINS */ , "in" /* IN */ , "array-contains-any" /* ARRAY_CONTAINS_ANY */ , "not-in" /* NOT_IN */ ], 2, n), o = Qu("Query.where", e), s = ca(this.$f, "Query.where", this.firestore.Ef, this.firestore.d_, o, i, r);
        ...
        var i = Qu("Query.orderBy", e), o = ha(this.$f, i, r);
        return new t(function(t, e) {
    ...
    /** Helper function to create a bound from a document or fields */ t.prototype.kf = function(t, e, n, i) {
        ...
        var s = {}, u = 0;
        if ("object" != typeof i[u] || Ju(i[u]) || (Z("Query.onSnapshot", s = i[u], [ "includeMetadataChanges" ]), 
        ...
        var c = {
            next: function(t) {
                i[u] && i[u](new ya(r.firestore, r.$f, t, r.m_));
            },
            error: i[u + 1],
            complete: i[u + 2]
        };
        return da(this.$f), this.firestore._f().listen(this.$f, s, c);
    }, t.prototype.get = function(t) {
        var e = this;
        B("Query.get", arguments, 0, 1), ba("Query.get", t), da(this.$f);
        var n = this.firestore._f();
        return (t && "cache" === t.source ? n.G_(this.$f) : n.z_(this.$f, t)).then((function(t) {
            return new ya(e.firestore, e.$f, t, e.m_);
        }));
    }, t;
}(), ya = /** @class */ function() {
    function t(t, e, n, r) {
    ...
    /** Check the equality. The call can be very expensive. */ t.prototype.isEqual = function(e) {
        ...
        return new aa(this.pf, t.key, t, e, n, this.m_);
    }, t;
}(), ma = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
    ...
    return t(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        var e = P.P(t);
        return oa.gf(this.$f.path.child(e), this.firestore, this.m_);
        ...
        // Call set() with the converted value directly to avoid calling toFirestore() a second time.
                return new oa(n.w_, this.firestore, null).set(e).then((function() {
            return n;
        }));
    }, n.prototype.withConverter = function(t) {
